...
namespace MobfishCardboard
{
    public static class CardboardLensDistortion
    {
        ...
        public static void RefreshProjectionMatrix()
        {
            ...
            CardboardLensDistortion_getProjectionMatrix(_lensDistortion, CardboardEye.kLeft, 0.1f, 1000f,
                projectionMatrixLeft);
            CardboardLensDistortion_getProjectionMatrix(_lensDistortion, CardboardEye.kRight, 0.1f, 1000f,
