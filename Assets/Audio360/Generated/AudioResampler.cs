...
public class AudioResampler : global::System.IDisposable {
  ...
  public virtual void setRatio(double resamplingRatio) {
    Audio360CSharpPINVOKE.AudioResampler_setRatio(swigCPtr, resamplingRatio);
  }

  public virtual double getRatio() {
    double ret = Audio360CSharpPINVOKE.AudioResampler_getRatio(swigCPtr);
    return ret;
  }
  ...
  public static AudioResampler create(uint numChannels, float inputSampleRate, float outputSampleRate, uint maxBufferSize, AudioResampler.Quality quality) {
    global::System.IntPtr cPtr = Audio360CSharpPINVOKE.AudioResampler_create(numChannels, inputSampleRate, outputSampleRate, maxBufferSize, (int)quality);
