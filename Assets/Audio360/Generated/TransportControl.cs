...
public class TransportControl : global::System.IDisposable {
  ...
  public virtual EngineError playScheduled(float millisecondsFromNow) {
    EngineError ret = (EngineError)Audio360CSharpPINVOKE.TransportControl_playScheduled__SWIG_0(swigCPtr, millisecondsFromNow);
    return ret;
  }

  public virtual EngineError playScheduled(float millisecondsFromNow, float fadeDurationInMs) {
    EngineError ret = (EngineError)Audio360CSharpPINVOKE.TransportControl_playScheduled__SWIG_1(swigCPtr, millisecondsFromNow, fadeDurationInMs);
    return ret;
  }
  ...
  public virtual EngineError pauseScheduled(float millisecondsFromNow) {
    EngineError ret = (EngineError)Audio360CSharpPINVOKE.TransportControl_pauseScheduled__SWIG_0(swigCPtr, millisecondsFromNow);
    return ret;
  }

  public virtual EngineError pauseScheduled(float millisecondsFromNow, float fadeDurationInMs) {
    EngineError ret = (EngineError)Audio360CSharpPINVOKE.TransportControl_pauseScheduled__SWIG_1(swigCPtr, millisecondsFromNow, fadeDurationInMs);
    return ret;
  }
  ...
  public virtual EngineError stopScheduled(float millisecondsFromNow) {
    EngineError ret = (EngineError)Audio360CSharpPINVOKE.TransportControl_stopScheduled__SWIG_0(swigCPtr, millisecondsFromNow);
    return ret;
  }

  public virtual EngineError stopScheduled(float millisecondsFromNow, float fadeDurationInMs) {
    EngineError ret = (EngineError)Audio360CSharpPINVOKE.TransportControl_stopScheduled__SWIG_1(swigCPtr, millisecondsFromNow, fadeDurationInMs);
    return ret;
  }
  ...
  public virtual void cancelScheduledParams() {
    Audio360CSharpPINVOKE.TransportControl_cancelScheduledParams(swigCPtr);
  }
