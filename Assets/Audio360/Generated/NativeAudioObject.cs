...
public class NativeAudioObject : SpatDecoderInterface {
  ...
  public virtual EngineError open(IOStream stream, bool shouldOwnStream, TBVector newPosition, float newGain) {
    EngineError ret = (EngineError)Audio360CSharpPINVOKE.NativeAudioObject_open__SWIG_3(swigCPtr, IOStream.getCPtr(stream), shouldOwnStream, TBVector.getCPtr(newPosition), newGain);
    if (Audio360CSharpPINVOKE.SWIGPendingException.Pending) throw Audio360CSharpPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
