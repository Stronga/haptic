...
public class NativeSpatDecoderFile : SpatDecoderInterface {
  ...
  public EngineError open(IOStream streamA, IOStream streamB, bool ownStreams, ChannelMap map) {
    EngineError ret = (EngineError)Audio360CSharpPINVOKE.NativeSpatDecoderFile_open__SWIG_4(swigCPtr, IOStream.getCPtr(streamA), IOStream.getCPtr(streamB), ownStreams, (int)map);
    return ret;
  }
