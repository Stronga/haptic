...
namespace Unity.Networking
{
    ...
    public struct BackgroundDownloadConfig
    {
        ...
        /// <summary>
        /// Whether to show a notification of the download in progress
        /// </summary>
        public bool showNotification;
        /// <summary>
        /// The title of the download notification (if notification is enabled)
        /// </summary>
        public string notificationTitle;
        /// <summary>
        /// The description on the download notification (if notification is enabled)
        /// </summary>
        ...
        /// <summary>
        /// Any custom unique ID that identifies this download. Will be restored on app restart
        /// </summary>
        public string uid;
        /// <summary>
        ...
        , IDisposable
    {
        ...
        /// <summary>
        /// How far the request has progressed (0 to 1), negative value if unknown. 
        /// Accessing this field can be very expensive (in particular on Android).
        /// </summary>
        ...
        /// <summary>
        /// Download progress as downloaded bytes. 
        /// Accessing this field can be very expensive (in particular on Android).
        /// </summary>
        public long downloadedBytes { get { return GetDownloadedBytes(); } }

        /// <summary>For internal use.</summary>
        protected abstract long GetDownloadedBytes();

        /// <summary>
        /// Total size of download in bytes (as per Content-Length header), may be 0 if unknown. 
        /// Accessing this field can be very expensive (in particular on Android).
        /// </summary>
        public long totalBytes { get { return GetTotalBytes(); } }
