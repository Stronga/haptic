...
namespace Headjack.Cinema.Messages
{
    ...
    ///
    /// </summary>
    public class MessageShowProject : MessageBase
    {
        ...
        public override int MessageType
        {
            get
            {
                return (int)DefaultMessages.ShowProject;
            }
        }

        public override MessageBase NewInstance()
        {
            return new MessageShowProject();
        }
        ...
        public override string ToString() {
            return $"[MessageShowProject] projectId: {projectId}";
        }
    }
}