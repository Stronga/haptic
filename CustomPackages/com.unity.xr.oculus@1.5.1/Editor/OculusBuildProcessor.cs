...
{
    public class OculusBuildProcessor : XRBuildHelper<OculusLegacySettings>
    {
        public override string BuildSettingsKey { get {return "Unity.XR.Oculus.LegacySettings";} }
        ...
        private bool HasLoaderEnabledForTarget(BuildTargetGroup buildTargetGroup)
        {
            ...
            {
                if (settings.Manager.activeLoaders[i] as OculusLegacyLoader != null)
                {
                    loaderFound = true;
                    break;
                }
            ...
            {
                if (settings.Manager.loaders[i] as OculusLegacyLoader != null)
                {
                    loaderFound = true;
                    break;
                }
    ...
    public static class OculusBuildTools
    {
        public static bool OculusLoaderPresentInSettingsForBuildTarget(BuildTargetGroup btg)
        {
            ...
            {
                if (settings.activeLoaders[i] as OculusLegacyLoader != null)
                {
                    loaderFound = true;
                    break;
                }
            ...
            return loaders.Exists(loader => loader is OculusLegacyLoader);
#endif
        }

        public static OculusLegacySettings GetSettings()
        {
            OculusLegacySettings settings = null;
#if UNITY_EDITOR
            UnityEditor.EditorBuildSettings.TryGetConfigObject<OculusLegacySettings>("Unity.XR.Oculus.LegacySettings", out settings);
#else
            settings = OculusLegacySettings.s_Settings;
#endif
            return settings;
        }
    }
