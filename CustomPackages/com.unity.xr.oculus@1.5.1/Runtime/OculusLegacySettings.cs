...
{
    [System.Serializable]
    [XRConfigurationData("OculusLegacy", "Unity.XR.Oculus.LegacySettings")]
    public class OculusLegacySettings : ScriptableObject
    {
...
#if !UNITY_EDITOR
		public static OculusLegacySettings s_Settings;
